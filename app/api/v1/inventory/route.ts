import { withKey, apiOk, apiErr, keyCan, requireScope, readBody, qParam, intParam, auditKeyWrite } from '@/lib/api-v1';
import { getInventory } from '@/lib/data';
import { createInventoryItem, type ItemPatch } from '@/lib/write';
import { itemMatchesQuery, itemInStorage } from '@/lib/inventory-shape';
