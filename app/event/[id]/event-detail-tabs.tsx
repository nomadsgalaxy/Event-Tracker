  ...
  return (
    <>
      <FieldGroup title="Outbound shipping">
        ...
        <BolManager eventId={eventId} direction="outbound" bols={bols} pallets={p.pallets ?? []} canEdit={canEdit} />
      </FieldGroup>
      ...
      <FieldGroup title="Return shipping">
        ...
        <BolManager eventId={eventId} direction="return" bols={bols} pallets={p.pallets ?? []} canEdit={canEdit} />
      </FieldGroup>
    </>
  );
}
