...
import type { EventDoc, EventPayload, Staffer, TravelInfo, TravelLeg, HotelInfo } from './types';

// lib/ical.ts — RFC 5545 .ics generation for the subscription feed (faithful to eit_calendar.gen_ics).
