...
import { AUTH_COLLECTION, type AuthDoc } from './auth';
import { encSecret, decSecret } from './totp';
import { rankOf } from './rbac';

// lib/calendar-feed.ts — per-user iCalendar (.ics) subscription tokens (mirrors server/eit_calendar.py).
//
