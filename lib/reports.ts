// lib/reports.ts — PURE, isomorphic report builders for the Reports screen (DESIGN_ALIGNMENT §4.9).
//
...
import { itemQtyInCase } from './case-view';
import { caseLoadedWeightKg } from './weight';
import { canSeeStaffPii, canSeeAccommodations } from './event-view';
import type { CasePayload, EventPayload, EventState, Staffer } from './types';
