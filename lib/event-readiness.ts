// lib/event-readiness.ts — PURE, isomorphic event-readiness + pallet read helpers.
//
...
import type { CasePayload, EventPallet, EventPayload } from './types';
import type { ManifestTotals } from './manifest-view';
import { caseLoadedWeightKg } from './weight';
import { getCaseScheduleConflicts, type CaseScheduleConflict } from './case-view';
import type { InventoryPayload } from './inventory-shape';
