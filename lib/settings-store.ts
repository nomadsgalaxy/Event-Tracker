...
import { AUTH_COLLECTION } from './auth';
import { tenantHash36 } from './eitm';
import { DEMO_MODE, demoDenied } from './demo';

// lib/settings-store.ts — the server-authoritative deployment SETTINGS store.
//
