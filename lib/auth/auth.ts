...
import { normalizeRole, rankOf, DEFAULT_ROLE, applyOverride, type OverrideDoc } from '@/lib/auth/rbac';
import type { Role } from '@/lib/types/types';

// lib/auth/auth.ts — password login + live role resolution + server guards.
//
