...
import { generateTotpSecret, totpUri, verifyTotp, encSecret, decSecret, generateRecoveryCodes } from '@/lib/auth/totp';
import { normalizeRole, VALID_ROLES } from '@/lib/auth/rbac';
import type { Role } from '@/lib/types/types';

// lib/auth/auth-store.ts — the server-authoritative credential-store mutators for the 2FA / recovery /
