...
import { GRANTS_COLLECTION, grantExpiry, type GrantDoc } from './grants';
import { viewerLeadsEvent } from './event-view';
import type { Envelope, EventDoc, Role } from './types';

// lib/notifications.ts — the server-side read/write path for the per-user notification feed.
//
