import 'server-only';
import { getEvents, getInventory, getTags, type TagDoc } from './data';
import {
  itemCaseIds,
  itemRollupState,
  type InventoryPayload,
} from './inventory-shape';
import { itemQtyInCase, buildCaseManifest } from './case-view';
import { startDayForecast } from './weather';
...
// lib/dashboard-metrics.ts — the ONE live read that powers the re-cast Archetype-A Dashboard.
//
