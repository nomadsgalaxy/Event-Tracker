// lib/case-view.ts — PURE, isomorphic case/manifest helpers.
//
...
import { parseEitm, type ParsedEitm } from './eitm';
import type { CasePayload, EventPayload, EventState } from './types';
