...
import { verifyApiKey, type VerifiedKey } from '@/lib/api/api-keys';
import { can, type AuthzCtx, type Capability } from '@/lib/auth/rbac';
import { WriteForbiddenError } from '@/lib/db/write';
import { DemoReadOnlyError } from '@/lib/db/demo';
import { writeAudit } from '@/lib/db/data';

// lib/api/api-v1.ts — the shared plumbing for the /api/v1 REST surface (the scoped key consumer).
//
